...
do {
  ...
  g++ $sol -o sol.exe -I $inc -O2 -Wall -Wextra -fdiagnostics-color=always -std=gnu++23
  ...
  g++ $gen -o gen.exe -I $inc -O2 -Wall -Wextra -fdiagnostics-color=always -std=gnu++23
  if ($LASTEXITCODE -ne 0) {
  ...
  g++ $ans -o ans.exe -I $inc -O2 -Wall -Wextra -fdiagnostics-color=always -std=gnu++23
  if ($LASTEXITCODE -ne 0) {
  ...
  g++ $che -o che.exe -I $inc -O2 -Wall -Wextra -fdiagnostics-color=always -std=gnu++23
  if ($LASTEXITCODE -ne 0) {
